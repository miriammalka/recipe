...
grant execute on UserFirstAndLastName to reciperole
grant execute on UsersDelete to reciperole
grant execute on ShowTotalCaloriesPerMeal to reciperole
grant execute on ShowRecipeInSpecifiedFormat to reciperole
...
grant execute on CloneARecipe to reciperole
...
grant execute on RecipeStatusGet to reciperole
